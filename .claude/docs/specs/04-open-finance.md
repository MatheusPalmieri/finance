...
| F7 | Testes (provider mock + fixtures anonimizadas) e docs | ✅ 66 testes do Open Finance (normalização, investimentos, sync, rotas, saldos); docs de domínio, API, frontend e infra |
