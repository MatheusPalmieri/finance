...
const FIRST_NAMES = [
  ...
  "Quezia", "Rafael", "Sofia", "Thiago", "Ursula", "Vinícius", "Wagner", "Yasmin",
...
const LAST_NAMES = [
  ...
  "Carvalho", "Rocha", "Dias", "Nascimento", "Moreira", "Cardoso", "Teixeira",
]

const BUSINESS_SUFFIX = [
  "Odontologia", "Clínica", "Consultório", "Estética", "Saúde", "Sorriso",
  "Dental", "Orto", "Implantes", "Center", "", "", "",
]

const CITIES = [
  "Blumenau", "Joinville", "Florianópolis", "Itajaí", "Balneário Camboriú",
  "Chapecó", "Criciúma", "São José", "Palhoça", "Lages", "Brusque", "Tubarão",
  "Jaraguá do Sul", "Caçador", "Concórdia", "Navegantes", "Camboriú", "Gaspar",
]

const AREA_CODES = ["47", "48", "49", "11", "21", "31", "41", "51", "61", "85"]

const WON_REASONS: CloseReason[] = ["CLIENT", "TRIAL", "CUSTOM_TRIAL"]
const LOST_REASONS: CloseReason[] = ["PRICE_OBJECTION", "NO_FIT", "GHOST", "UNREACHABLE"]
...
function randomPhone(): string {
  const number = `9${randInt(10000000, 99999999)}`
