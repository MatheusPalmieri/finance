...
const CLOSE_REASON_OPTIONS = Object.entries(CLOSE_REASON_LABELS) as [CloseReason, string][]
  ...
  return (
    <Dialog open={!!client} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="sm:max-w-sm">
        ...
        <form onSubmit={handleSubmit(onSubmit)} id="phase-form">
        ...
        <DialogFooter>
          ...
          <Button type="submit" form="phase-form" disabled={update.isPending}>
